      ...
      <div className="min-h-screen hud-grid flex items-center justify-center p-6">
        <div className="w-full max-w-2xl premium-card p-16 border-white/10 shadow-[0_0_50px_rgba(0,0,0,0.8)] relative overflow-hidden text-center">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-5xl font-black theme-text premium-heading mb-4 tracking-tight">Connect Hub</h1>

            {/* Show login email as hint */}
            {userEmail && (
              <div className="inline-flex items-center gap-2.5 mb-6 px-4 py-2 rounded-full"
                style={{ background: 'rgba(99,102,241,0.1)', border: '1px solid rgba(99,102,241,0.25)' }}>
                <img src="https://www.gstatic.com/firebasejs/ui/2.0.0/images/auth/google.svg" alt="Google" className="w-4 h-4" />
                <span className="text-sm font-bold text-indigo-400">Sign in as <span className="text-white">{userEmail}</span></span>
              </div>
            )}
